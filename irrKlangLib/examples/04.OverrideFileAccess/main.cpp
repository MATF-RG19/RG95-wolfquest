...
// a class implementing the IFileFactory interface to override irrklang file
// access
...
protected:
  ...
  public:
    ...
    ik_s32 getSize() { return FileSize; }

    //! returns where in the file we are.
    ik_s32 getPos() { return ftell(File); }

    //! returns name of file
    const ik_c8 *getFileName() { return Filename; }
...
int main(int argc, const char **argv) {
  ...
  printf(
      "Press any key to start playing sounds, then press escape to cancel\n");
