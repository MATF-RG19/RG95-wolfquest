// This example will show how to use sound effects such as echo, reverb and
// distortion. irrKlang supports the effects Chorus, Compressor, Distortion,
// Echo, Flanger Gargle, 3DL2Reverb, ParamEq and WavesReverb.
...
int main(int argc, const char **argv) {
  ...
  ISound *music =
      engine->play2D(filename, true, false, true, ESM_AUTO_DETECT, true);
