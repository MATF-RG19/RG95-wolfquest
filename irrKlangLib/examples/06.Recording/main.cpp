...
// The following will simply start up the irrklang engine, create an audio
// recorder, record some audio when the user presses a key, and save that data
// to a wave file. Additionally, the data is added into the sound engine and
// played back as well.
int main(int argc, const char **argv) {
  ...
  printf("\nRecording done, recorded %dms of audio.\n",
         recorder->getAudioFormat().FrameCount * 1000 /
             recorder->getAudioFormat().SampleRate);
